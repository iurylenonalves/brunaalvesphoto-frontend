...
const Portfolio = () => {
  ...
  const portfolioImages: PortfolioImages = {
    ...
    [
      ...
      { base: "work18" }, { base: "work19" }, { base: "work20" },
      { base: "work21" }, { base: "work22" }, { base: "work23" },
      { base: "work24" }, { base: "work25" }, { base: "work26" },
      { base: "work27" }, { base: "studio01" }, { base: "studio02" },
      { base: "studio03" }, { base: "studio04" }, { base: "studio05" },
      { base: "studio06" }, { base: "studio07" }, { base: "studio08" },
      { base: "studio09" }, { base: "studio10" }, { base: "studio11" },
      { base: "studio12" }, { base: "studio13" }, { base: "studio14" },
      { base: "studio15" }, { base: "studio16" }, { base: "studio17" },
      { base: "studio18" }, 
    ],
    travel: 
    [
    ...
    [
      ...
      { base: "studio16" }, { base: "studio17" }, { base: "studio18" },
    ],
  };
